          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-6">
              {[
                ...
                >
                  <Link 
                    href={item.href}
                    className="font-poppins text-white font-bold text-sm border-2 border-white/30 px-6 py-3 rounded-full bg-black/20 backdrop-blur-sm hover:bg-white hover:text-black transition-all duration-300"
                  >
                    {item.name}
                  </Link>
                </motion.div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <motion.button
                ...
                className="lg:hidden p-3 rounded-full bg-black text-white hover:bg-green-600 transition-colors border-2 border-black"
              >
                <motion.div
